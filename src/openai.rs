...
/// Why did I document all of this? Yes.
...
pub struct CreateCompletionRequestBody<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub logit_bias: Option<HashMap<&'a str, i8>>,
...
/// ... there wasn't really any documentation for the response.
...
pub struct CreateCompletionResponse {
    ...
    pub usage: CreateCompletionResponseUsage,
}
...
pub async fn create_completion(body: CreateCompletionRequestBody<'_>) -> CreateCompletionResponse {
    ...
    client.post("https://api.openai.com/v1/completions")
        ...
        .json(&body)
        .send().await
        .expect("HTTP request should complete successfully")
        .json().await
        .expect("response should be JSON and should deserialize into CreateCompletionResponse structure")
}
